...
export default function Home() {
  return (
    <div className='flex items-center justify-center md:gap-x-10 w-svw h-svh bg-secondary md:px-5'>
      ...
      <div className='w-96 h-56 rounded-full bg-success absolute top-0 md:right-[26%] right-0 z-10 blur-3xl'></div>
      ...
      <div className='w-96 h-[90vh] bg-secondary shadow-2xl rounded-3xl z-50 p-4 hidden md:flex'>panel</div>
      <Map />
    </div>
  );
}
